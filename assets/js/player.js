...
function init() {
  playerModule.audio.addEventListener('timeupdate', chaptersModule.highlightCurrentChapter);
  chaptersModule.bindChapterEvents();
  playerModule.playButton.addEventListener('click', playerModule.toggleAudio);
}
